...
# ==== 1️⃣ Load model ====
#fine-tuned/unetMobileNetV2_finetuned.keras
#fine-tuned/unet_decoder_finetuned_best.h5
#Deeplab/deeplab_fined-tune-GD2.keras
#final/UnetMobileV2_UnitedData.keras
#final/BestLoss.tflite
#
model_path = "final/UnetMobileV2_Last.keras"  # đường dẫn model của bạn
...
def segment_frame(frame):
    ...
    mask = (pred[..., 0] > 0.65).astype(np.uint8)  # Áp dụng ngưỡng
